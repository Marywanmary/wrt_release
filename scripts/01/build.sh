...
CONFIG_FILE="$BASE_PATH/deconfig/01/$Dev.config"
INI_FILE="$BASE_PATH/compilecfg/01/$Dev.ini"
...
$BASE_PATH/01/update.sh "$REPO_URL" "$REPO_BRANCH" "$BASE_PATH/$BUILD_DIR" "$COMMIT_HASH"
