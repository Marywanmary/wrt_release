...
CONFIG_FILE="$BASE_PATH/deconfig/02/$Dev.config"
INI_FILE="$BASE_PATH/compilecfg/02/$Dev.ini"
...
$BASE_PATH/02/update.sh "$REPO_URL" "$REPO_BRANCH" "$BASE_PATH/$BUILD_DIR" "$COMMIT_HASH"
