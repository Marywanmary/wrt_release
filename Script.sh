...
# ====== 移除要替换的kenzok8包 ======
rm -rf smpackage/luci-app-wolplus
rm -rf smpackage/luci-app-openlist2
rm -rf smpackage/luci-app-ariang
rm -rf smpackage/luci-app-frp
rm -rf smpackage/luci-app-lucky
rm -rf smpackage/luci-app-OpenAppFilter
rm -rf smpackage/tailscale
